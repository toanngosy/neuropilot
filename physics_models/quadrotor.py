    ...
    def state_dot(self):
        ...
        x_dotdot = np.array([0, 0, -self.m*self.g]) + \
            np.dot(self.rotation_matrix(self.state[6:9]),
                   np.array([0, 0, (self.motor1.thrust + self.motor2.thrust + self.motor3.thrust + self.motor4.thrust)]))/self.m
        ...
        tau = np.array([self.L*(self.motor1.thrust-self.motor3.thrust),
                        ...
                        self.b*(self.motor1.thrust-self.motor2.thrust + self.motor3.thrust-self.motor4.thrust)])
